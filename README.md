...
`https://сайт/префикс/joyproxy/img1.reactor.cc/pics/post/mp4/видосик.mp4`

Сгенерировать ссылку можно запостив урл с видосиком в форму на страничке
`https://сайт/префикс/joyurl`

## Как это работает?

При обращении к сгенерённому урлу, апи вначале идёт на сайт, выкачивает
видосик во временный каталог, отдаёт видосик клиенту и удаляет его из
временного каталога. Есть встроенное ограничение на размер файла в 10Мб.
